        ...
        <div className="container px4 min-h-[65vh] 2xl:px-20 mx-auto my-10">
           ...
           <div className="flex gap-2 mb-6 mt-3">
            {
                ...
                <label htmlFor="resumeUpload" className="flex items-center">
                  ...
                  className=''
                  id="resumeUpload" accept='application/pdf' type="file" hidden />
                  <img src={assets.profile_upload_icon} alt="upload_icon" />
                </label>
           ...
           <h2 className="text-xl font-semibold mb-4">Jobs Applied</h2>
            <table className="min-w-full bg-white rounded-lg border border-gray-300">
              <thead className="">
                <tr className="">
                  <th className="py-3 px-4 border-b text-left border-gray-300 max-sm:hidden">Company</th>
                  <th className="py-3 px-4 border-b text-left border-gray-300 max-sm:hidden">Job Title</th>
                  ...
                  <th className="py-3 px-4 border-b text-left border-gray-300 max-sm:hidden">Status</th>
                </tr>
              </thead>
              <tbody className="">
